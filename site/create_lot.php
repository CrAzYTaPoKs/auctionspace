...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    ");
       ...
       if ($stmt->execute([$category_id, $title, $description, $start_price, $current_price, $end_time, $user_id])) {
...
<div class="container">
    ...
    <div class="form-container">
        ...
        <div class="info-note">
            💡 После создания объявления другие пользователи смогут делать ставки. 
            Торги автоматически завершатся в указанное время.
        </div>
